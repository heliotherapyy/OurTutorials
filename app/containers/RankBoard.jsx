...
import {createLink, fetchLinks, incrementLike, decrementLike, destroyLink} from 'actions/links';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <EntryBox  onEntrySave = { addCategory} currentCategory ={currentCategory} />
